...
export const PROJECT_STATUS_COLOR_MAP = {
  ...
  [ProjectStatus.REJECTED_ONBOARD]: "#B22222", // Firebrick
  [ProjectStatus.REJECTED_DONE]: "#A52A2A", // Brown
};

export const PROJECT_STATUS_TEXT_MAP = {
  [ProjectStatus.STATUS_NO_USE]: "No Use",
  ...
  [ProjectStatus.REJECTED_ONBOARD]: "Rejected Onboard",
  [ProjectStatus.REJECTED_DONE]: "Rejected Done",
};
